...
M.Color = {
        ...
        background = ({ { 0.03, 0.03, 0.03 }, { 0.4, 0.4, 0.4 }, { 0.75, 0.75, 0.75 } })[config.CURRENT_THEME], -- dark waters low_light ─ exposure: 0.0625, decay: 0.60
        creature_healed = { 0.75, 0.75, 0.75 },
        creature_healing = { 0.85, 0.3, 0.5 }, --- (pink)
        creature_infected = ({ { 0.9, 0.8, 0.5, 0.5 }, { 0.25 + 0.1, 0.9 + 0.1, 0.6 + 0.2 }, { 0.05, 0.05, 0.05 } })[config.CURRENT_THEME], -- green low_light
